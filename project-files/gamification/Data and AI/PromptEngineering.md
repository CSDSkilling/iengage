...
1. Being too vague:
   When a prompt is too vague, the LLM may provide a broad or irrelevant response. It's important to be specific to get the desired output.
...
2. Asking multiple questions in one prompt:
   Asking multiple questions in one prompt can confuse the LLM and result in incomplete or mixed responses. It's better to split them into separate prompts.
